...
import { ChevronLeft, ChevronRight, Search, BookOpen, ArrowLeft } from "lucide-react"
...
export default function PublicMushafPage() {
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-2xl md:text-3xl font-bold">Mushaf - القرآن الكريم</h1>
            </div>
